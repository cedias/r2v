...
subprocess.call(["python3.4 treebank_to_R2V.py --classes 2 --output treebank.d2v Data/stanfordSentimentTreebank"],shell=True)
subprocess.call(["./d2v/d2v -train treebank.d2v -output treebank_d2v.bin -binary 1 -hs 0 -window 10 -sample 0 -min-count 0 -negative 15 -sentence-vectors 1 -cbow 0 -iter 10 -threads {}".format(args.threads)],shell=True)
subprocess.call(["python3.4 treebank_results.py --classes 2 treebank_d2v.bin "],shell=True)
